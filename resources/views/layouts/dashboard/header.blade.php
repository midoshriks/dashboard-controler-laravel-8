    ...
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ route('dashboard.index') }}">
                {{-- <img src="{{ asset('dashboard/src/static/logo.svg') }}" width="110" height="32" alt="Tabler"
                    class="navbar-brand-image"> --}}
                <div class="page-pretitle">
                    <img src="{{ asset('dashboard/src/static/smart_logo.png') }}" width="50" alt=""
                        srcset="">
                    {{ display('Smart bucks') }}
                </div>
            </a>
                                ...
                                @foreach (Auth::user()->unreadNotifications as $notification)
                                    <div class="list-group-item">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <a href="#" class="list-group-item-actions d-block">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm"
                        style="background-image: url({{ Auth()->user()->getMedia('first_name')->last()? Auth()->user()->getMedia('photo_user')->last()->getUrl('mobile'): Auth()->user()->photo_user }})"></span>
                    <div class="d-none d-xl-block ps-2">
                        <div>{{ Auth()->user()->first_name }}</div>
                        <div class="mt-1 small text-muted">{{ Auth()->user()->last_name }}r</div>
                    </div>
                </a>
