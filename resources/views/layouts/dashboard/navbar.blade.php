            ...
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('dashboard.pages.index') }}">
                            {{ display('pages') }}
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-file-orientation" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('dashboard.languages.index') }}">
                        {{ display('translate') }}
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-language-katakana" width="24"
                    ...
                    @if (auth()->user()->code_membership == '001')
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('dashboard.mail.index') }}">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-mail-forward" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
