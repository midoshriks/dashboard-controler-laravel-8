        ...
        <div class="page-header d-print-none">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        {{ display('Dashboard') }} \ {{ display('lang') }} \ {{ display('edit') }} \
                        {{ $lang->phrase }}
                    </h2>
                </div>
            </div>
                        ...
                        <div class="modal-body align-self-center">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title" style="margin-right: 5px;">{{ display('form edit languages ') }}
                                    </h3>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('dashboard.languages.update', $lang->id) }}" method="post"
                                        ...
                                        <div class="form-group mb-3 col-md-12 d-flex">
                                            <div class="col-sm-6 m-1">
                                                <label class="form-label required">{{ display('lang en') }}</label>
                                                <div class="">
                                            ...
                                            <div class="col-sm-6 m-1">
                                                <label class="form-label required">{{ display('lang ar') }}</label>
                                                <div>
